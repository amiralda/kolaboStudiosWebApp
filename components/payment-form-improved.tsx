...
import type { OrderData, StripeCardChangeEvent, ApiResponse } from '@/lib/types'

// ✅ Proper Stripe initialization with error handling
const stripePromise = (() => {
...
function CheckoutForm({ paymentData, amount, onSuccess, onError }: PaymentFormProps) {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (stripeError) {
        ...
        SafeStorage.removeItem('retouchOrder')
  ...
  // ✅ Proper Stripe Elements options
